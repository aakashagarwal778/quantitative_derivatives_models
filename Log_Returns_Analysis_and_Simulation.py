...
#Plotting both logReturns and Sim_lgReturns
plt.plot(logReturns, color='blue')
plt.plot(sim_log_returns, color='yellow', alpha = 0.7)
plt.title("log-returns of DAX in the period 01.01.1990 - 2024.04.18")
plt.xlabel('Trading Days')
plt.ylabel("log Returns and Simulated log Returns")
